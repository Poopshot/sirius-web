...
public class ViewRepresentationDescriptionSearchService implements IViewRepresentationDescriptionSearchService {
    ...
    public ViewRepresentationDescriptionSearchService(ViewRepresentationDescriptionSearchServiceParameters viewRepresentationDescriptionSearchServiceParameters,
            IInMemoryViewRegistry inMemoryViewRegistry) {
        this.urlParser = Objects.requireNonNull(viewRepresentationDescriptionSearchServiceParameters.getUrlParser());
        this.documentRepository = Objects.requireNonNull(viewRepresentationDescriptionSearchServiceParameters.getDocumentRepository());
        this.ePackageRegistry = Objects.requireNonNull(viewRepresentationDescriptionSearchServiceParameters.getePackageRegistry());
        this.diagramIdProvider = Objects.requireNonNull(viewRepresentationDescriptionSearchServiceParameters.getDiagramIdProvider());
        this.formIdProvider = Objects.requireNonNull(viewRepresentationDescriptionSearchServiceParameters.getFormIdProvider());
        this.ganttIdProvider = Objects.requireNonNull(viewRepresentationDescriptionSearchServiceParameters.getGanttIdProvider());
        this.objectService = Objects.requireNonNull(viewRepresentationDescriptionSearchServiceParameters.getObjectService());
