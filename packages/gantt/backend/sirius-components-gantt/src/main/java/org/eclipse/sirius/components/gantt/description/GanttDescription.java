...
@PublicApi
@Immutable
public final class GanttDescription implements IRepresentationDescription {
    ...
    public static final class Builder {
        ...
        public GanttDescription build() {
            GanttDescription ganttDescription = new GanttDescription();
            ganttDescription.id = Objects.requireNonNull(this.id);
            ganttDescription.label = Objects.requireNonNull(this.label);
            ganttDescription.idProvider = Objects.requireNonNull(this.idProvider);
            ganttDescription.canCreatePredicate = Objects.requireNonNull(this.canCreatePredicate);
            ganttDescription.labelProvider = Objects.requireNonNull(this.labelProvider);
            ganttDescription.targetObjectIdProvider = Objects.requireNonNull(this.targetObjectIdProvider);
            ganttDescription.taskDescriptions = Objects.requireNonNull(this.taskDescriptions);
