...
public class TaskPackageImpl extends EPackageImpl implements TaskPackage {
     ...
     */
    @Override
    public EAttribute getAbstractTask_Tags() {
        return (EAttribute) this.abstractTaskEClass.getEStructuralFeatures().get(6);
    }
    ...
    public void createPackageContents() {
        ...
        this.createEAttribute(this.abstractTaskEClass, ABSTRACT_TASK__TAGS);
    ...
    public void initializePackageContents() {
        ...
        this.initEAttribute(this.getAbstractTask_StartDate(), this.ecorePackage.getELong(), "startDate", null, 0, 1, AbstractTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        this.initEAttribute(this.getAbstractTask_EndDate(), this.ecorePackage.getELong(), "endDate", null, 0, 1, AbstractTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        this.initEAttribute(this.getAbstractTask_Tags(), this.ecorePackage.getEString(), "tags", null, 0, -1, AbstractTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
