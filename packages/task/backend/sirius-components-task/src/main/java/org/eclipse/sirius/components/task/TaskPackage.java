...
public interface TaskPackage extends EPackage {
    ...
    /**
     * The feature id for the '<em><b>Tags</b></em>' attribute list. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     * @ordered
     */
     ...
     * @ordered
     */
    int PROJECT__OWNED_OBJECTIVES = 1;
    ...
    /**
     * Returns the meta object for the attribute list '{@link org.eclipse.sirius.components.task.AbstractTask#getTags
     ...
     * @generated
     */
    EAttribute getAbstractTask_Tags();
     ...
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for the containment reference list '<em>Assigned Persons</em>'.
     ...
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for the containment reference list '<em>Assigned Teams</em>'.
    ...
    interface Literals {
        ...
        /**
         * The meta object literal for the '<em><b>Tags</b></em>' attribute list feature. <!-- begin-user-doc --> <!--
         * end-user-doc -->
         *
         * @generated
         */
        EAttribute ABSTRACT_TASK__TAGS = eINSTANCE.getAbstractTask_Tags();
        ...
        /**
         * The meta object literal for the '<em><b>Assigned Persons</b></em>' containment reference list feature. <!--
         * begin-user-doc --> <!-- end-user-doc -->
         *
         * @generated
         */
        ...
        /**
         * The meta object literal for the '<em><b>Assigned Teams</b></em>' containment reference list feature. <!--
         * begin-user-doc --> <!-- end-user-doc -->
         *
         * @generated
         */
