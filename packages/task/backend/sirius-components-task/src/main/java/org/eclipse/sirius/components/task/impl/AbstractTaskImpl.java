...
public abstract class AbstractTaskImpl extends MinimalEObjectImpl.Container implements AbstractTask {
    ...
    /**
     * The cached value of the '{@link #getTags() <em>Tags</em>}' attribute list. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #getTags()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getAssignedTeams() <em>Assigned Teams</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    public EList<String> getTags() {
        if (this.tags == null) {
            this.tags = new EDataTypeUniqueEList<>(String.class, this, TaskPackage.ABSTRACT_TASK__TAGS);
        }
        return this.tags;
    }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case TaskPackage.ABSTRACT_TASK__DESCRIPTION:
                ...
                return;
            case TaskPackage.ABSTRACT_TASK__START_DATE:
                this.setStartDate((Long) newValue);
                return;
            case TaskPackage.ABSTRACT_TASK__END_DATE:
                this.setEndDate((Long) newValue);
                return;
            case TaskPackage.ABSTRACT_TASK__PROGRESS:
            ...
            case TaskPackage.ABSTRACT_TASK__TAGS:
                this.getTags().clear();
                this.getTags().addAll((Collection<? extends String>) newValue);
                return;
            case TaskPackage.ABSTRACT_TASK__DEPENDENCIES:
