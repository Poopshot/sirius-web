...
- https://github.com/eclipse-sirius/sirius-web/issues/2567[#2567] [form] Improve the typing of the API used to contribute custom property sections by removing some usage of TypeScript generics which could not work.
- https://github.com/eclipse-sirius/sirius-web/issues/2567[#2567] [form] Extract the frontend code of the Slide widget into a dedicated npm package similar to the reference witg one.
The backend code will also have to be extracted properly in the near future.
- https://github.com/eclipse-sirius/sirius-web/issues/2567[#2567] [siriusweb] The SiriusWebApplication now provides both custom widgets slider and reference automatically.
...
- https://github.com/eclipse-sirius/sirius-web/issues/2985[#2985] Move some code in `sirius-web-application` to identify more clearly the API part of the npm package.
